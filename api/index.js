...
videos.get('/:image',ctrl.video.show);
videos.put('/:image',jwt,roles.can('edit content'),multi,ctrl.video.update);
videos.delete('/:image',jwt,roles.can('edit content'),ctrl.video.destroy);
