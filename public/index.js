...
},{"./ruler":21,"./rules_block/blockquote":22,"./rules_block/code":23,"./rules_block/deflist":24,"./rules_block/fences":25,"./rules_block/footnote":26,"./rules_block/heading":27,"./rules_block/hr":28,"./rules_block/htmlblock":29,"./rules_block/lheading":30,"./rules_block/list":31,"./rules_block/paragraph":32,"./rules_block/state_block":33,"./rules_block/table":34}],18:[function(require,module,exports){
...
},{"./ruler":21,"./rules_core/abbr":35,"./rules_core/abbr2":36,"./rules_core/block":37,"./rules_core/footnote_tail":38,"./rules_core/inline":39,"./rules_core/linkify":40,"./rules_core/references":41,"./rules_core/replacements":42,"./rules_core/smartquotes":43}],19:[function(require,module,exports){
// Inline parser
...
},{"./common/utils":7,"./ruler":21,"./rules_inline/autolink":44,"./rules_inline/backticks":45,"./rules_inline/del":46,"./rules_inline/emphasis":47,"./rules_inline/entity":48,"./rules_inline/escape":49,"./rules_inline/footnote_inline":50,"./rules_inline/footnote_ref":51,"./rules_inline/htmltag":52,"./rules_inline/ins":53,"./rules_inline/links":54,"./rules_inline/mark":55,"./rules_inline/newline":56,"./rules_inline/state_inline":57,"./rules_inline/sub":58,"./rules_inline/sup":59,"./rules_inline/text":60}],20:[function(require,module,exports){
'use strict';
...
},{"./common/utils":7}],21:[function(require,module,exports){
...
},{"../common/html_blocks":4}],30:[function(require,module,exports){
// lheading (---, ===)
...
},{"../helpers/parse_link_label":14,"../rules_inline/state_inline":57}],36:[function(require,module,exports){
...
},{"autolinker":61}],41:[function(require,module,exports){
'use strict';
...
},{"../helpers/normalize_reference":12,"../helpers/parse_link_destination":13,"../helpers/parse_link_label":14,"../helpers/parse_link_title":15,"../rules_inline/state_inline":57}],42:[function(require,module,exports){
...
},{"../common/url_schemas":6,"../helpers/normalize_link":11}],45:[function(require,module,exports){
// Parse backticks
...
},{"../common/entities":3,"../common/utils":7}],49:[function(require,module,exports){
...
},{"../helpers/parse_link_label":14}],51:[function(require,module,exports){
...
},{"../common/html_re":5}],53:[function(require,module,exports){
...
},{"../helpers/normalize_reference":12,"../helpers/parse_link_destination":13,"../helpers/parse_link_label":14,"../helpers/parse_link_title":15}],55:[function(require,module,exports){
...
module.exports=/*@ngInject*/["$provide", function($provide){
  $provide.decorator("d3",["$delegate", function($delegate){
    ...
    var boxQuartiles=function(d) {
      return [
        $delegate.quantile(d, .25),
        $delegate.quantile(d, .5),
        $delegate.quantile(d, .75)
      ];
    };
  
    $delegate.box = function() {
      var width = 1,
          height = 1,
          duration = 0,
          domain = null,
      ...
      function box(g) {
        g.each(function(data, i) {
          //d = d.map(value).sort($delegate.ascending);
    	  //var boxIndex = data[0];
    	  //var boxIndex = 1;
    	  var d = data[1].sort($delegate.ascending);
    	  
    	 // console.log(boxIndex); 
    	  //console.log(d); 
    	  
          var g = $delegate.select(this),
              n = d.length,
              min = d[0],
              max = d[n - 1];
          ...
          var outlierIndices = whiskerIndices
              ? $delegate.range(0, whiskerIndices[0]).concat($delegate.range(whiskerIndices[1] + 1, n))
              : $delegate.range(n);
    
          // Compute the new x-scale.
          var x1 = $delegate.scale.linear()
              .domain(domain && domain.call(this, d, i) || [min, max])
              .range([height, 0]);
    
          // Retrieve the old x-scale, if this is an update.
          var x0 = this.__chart__ || $delegate.scale.linear()
              .domain([0, Infinity])
    		 // .domain([0, max])
              .range(x1.range());
      ...
      box.domain = function(x) {
        ...
        domain = x == null ? x : $delegate.functor(x);
        return box;
      };
...
},{"./boxplot/boxplot-decorator":63,"./boxplot/boxplot-directive":64,"./d3-service":65}],67:[function(require,module,exports){
(function (global){
var angular=(typeof window !== "undefined" ? window.angular : typeof global !== "undefined" ? global.angular : null);
...
},{"./mathjax-directive":68,"./mathjax-provider":69}],68:[function(require,module,exports){
...
},{"./remarkable-directive":71,"./remarkable-provider":72,"remarkable":2}],71:[function(require,module,exports){
...
module.exports=/*@ngInject*/["Restangular", "$window", function(Restangular,$window){
...
},{"./auth-interceptor":73,"./identity-service":74,"./test-item-directive":76,"./user-available-validator":77,"./user-exists-validator":78}],76:[function(require,module,exports){
module.exports=/*@ngInject*/function(){
  return {
    scope: {
      item: "=",
